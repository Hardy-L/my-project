...
<div class="bottom">
  <div class="loding">待支付¥{{$store.state.num}}</div>
  <router-link to="/info_data">
  <div class="order" @click="dianji">确认下单</div>
  </router-link>
</div>
  </div>
</template>
...
.top-left {
  ...
  font-size: 1.6rem;
  padding: 0.3rem;
  /* background: repeating-linear-gradient(to right, skyblue 5%, pink 10%); */
}
.top-right {
  float: right;
  font-size: 1rem;
